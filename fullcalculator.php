...
function getInputValue($inputName) {
    return isset($_GET[$inputName]) ? htmlspecialchars($_GET[$inputName]) : 0;
}
...
if (isset($_GET["num1"], $_GET["num2"], $_GET["num3"], $_GET["operator"])) {
    $num1 = getInputValue("num1");
    $num2 = getInputValue("num2");
    $num3 = getInputValue("num3");
    $op = $_GET["operator"];
    $result = "";
    ...
    switch ($op) {
        ...
        case "percent":
             ...
             break;
        case "exponent":
            $result = pow($num1, $num2); // Removed num3,  pow function only takes two arguments
            break;
        default:
